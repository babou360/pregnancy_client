                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                          ...
                          validator: (value) {
                            if (value.isEmpty) {
                              return 'Tafadhali jaza blood count';
                            } else {
                              return null;
                            }
                          },
              ...
              children: [
                GestureDetector(
                  ...
                  child: Container(
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text('Ongeza CBC',style: TextStyle(fontWeight: FontWeight.w500)),
                    ),
                    decoration: BoxDecoration(
                      border: Border.all(
                        width: 2,
                ...
                Text('BLOOD COUNT',
                style: TextStyle(fontWeight: FontWeight.w400,color: Colors.green[400],fontSize: 18,fontFamily: 'CustomIcons')),
                GestureDetector(
                  onTap: (){
                    showDialog(
                    context: context,
